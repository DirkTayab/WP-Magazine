...
<section>
    <div class="container">
          ...
          <div
            ...
            id="single-article-details"
          >
            <div class="details">
              <ul>
                <li><span>Author:</span> <?php echo get_the_terms($post->ID, 'categories')[0]->name?></li>
                <li><span>Date:</span> <?php echo get_the_date('j, F Y')?></li>
                <li><span>Duration:</span> <?php the_field('duration')?></li>
              </ul>
            </div>
            <a href="#" class="block category" id="single-article-category"
              >Label</a
            >
          </div>
          ...
          <div class="grid grid-cols-[300px_1fr] gap-20 my-20">
            <aside class="sticky top-0 self-start">
              <div class="flex gap-5 pb-5 mb-5 border-b border-dark">
                <img
                src="<?php $author = get_field('author'); 
              if ($author) {
                $author_post_id = $author->ID;
                $thumbnail_url = get_field('thumbnail', $author_post_id); 
...
<section class="mb-20 latest">
        <div class="container">
          ...
          <div
            class="grid overflow-hidden border md:grid-cols-3 border-dark lastest-grid">
